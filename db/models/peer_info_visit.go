...
type PeerInfoVisit struct {
	...
	DurationMs      time.Duration `ch:"duration_ms" json:"duration_ms"`         // Time taken to establish connection/gather info
	...
	MultiAddresses  []string      `ch:"multiAddresses" json:"multiAddresses"`   // Network addresses where peer can be reached
