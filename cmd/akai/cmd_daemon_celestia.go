...
var cmdDaemonCelestiaNamespaceFlags = []cli.Flag{
	...
	&cli.DurationFlag{
		...
		Sources: cli.ValueSourceChain{
			Chain: []cli.ValueSource{cli.EnvVar("AKAI_DAEMON_API_HTTP_TIMEOUT")},
		},
		Usage:       "Duration for the HTTP API operations (20s, 1min)",
		DefaultText: cmdDaemonCelestiaNamespaceConf.AkaiAPIServiceConfig.Timeout.String(),
		Value:       cmdDaemonCelestiaNamespaceConf.AkaiAPIServiceConfig.Timeout,
		Destination: &cmdDaemonCelestiaNamespaceConf.AkaiAPIServiceConfig.Timeout,
	},
}
...
func cmdDaemonCelestiaNamespaceAction(ctx context.Context, cmd *cli.Command) error {
	log.WithFields(log.Fields{
		...
		"akai-api-timeout": cmdDaemonCelestiaNamespaceConf.AkaiAPIServiceConfig.Timeout,
